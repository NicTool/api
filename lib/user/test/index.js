  ...
  describe('GET', function () {
    ...
    it('searches, sorts, and paginates users', async () => {
      ...
      try {
        ...
        assert.deepEqual(exact.map((u) => u.username), ['unit-search-beta'])
        ...
        assert.deepEqual(page.map((u) => u.username), ['unit-search-beta', 'unit-search-alpha'])
